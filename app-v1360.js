...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.6.0 hard guard: visible Step-6 result stays authoritative.
...
// V13.6.0 Calculate V01 + fresh page fix.

// V13.6.0: Step-7 no longer erases Bartender Step-6 server totals.

// V13.6.0 Employee Clear All fix.

// V13.6.0 Small Report tab + signature XLS.

// V13.6.0 dedicated Hourly Adjustment sub-app.

// V13.6.0 fresh page generated from current index.

// V13.6.0 Edit finalized Hourly report from Small Report.

// V13.6.0 Small Report + New Entry.
