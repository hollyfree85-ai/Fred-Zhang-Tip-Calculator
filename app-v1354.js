...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.5.4 hard guard: visible Step-6 result stays authoritative.
...
// V13.5.4 Calculate V01 + fresh page fix.

// V13.5.4: Step-7 no longer erases Bartender Step-6 server totals.
