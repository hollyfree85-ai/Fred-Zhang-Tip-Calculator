...
// V13.8.17I — reusable Show Password checkbox for all password/PIN inputs.
...
// V13.8.17I reliable team-card click handling (desktop/tablet/mobile).
...
window.openHourlyWorkspacePanel=function(name){
  // V13.8.17IA: Hourly V01 is no longer an isolated sub-app.
...
function listenEmployeeHistoricalReports(){
  ...
  unsubs.push(onSnapshot(qh,snap=>{
    ...
    const host=$("employeeHistoricalReports");
    if(host){
      host.innerHTML=`<div class="notice danger"><b>Could not load My Tip Reports.</b><br>${esc(e.code||e.message||"Firestore permission error")}<br><span class="small">Publish the V13.8.17I hourlyReports employee-read rule.</span></div>`;
    }
  }));
}
...
async function loadDeletedItems(){
  ...
  try{
    ...
    if(currentProfile?.role==="owner"&&$("deletedItemsList")){
      $("deletedItemsList").innerHTML=`<div class="notice danger">Deleted / Undo could not load: ${esc(e.code||e.message)}. Publish the V13.8.17I Firestore rules.</div>`;
    }
  }
}
...
window.employeeDeleteTipCheckDate=async function(encodedDate){
  ...
  try{
    ...
    alert(`Delete failed: ${e.code||e.message}\n\nIf this says permission-denied, publish the V13.8.17I Firestore rules.`);
  }
};
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.8.17I hard guard: visible Step-6 result stays authoritative.
  ...
  // V13.8.17I Busser split. Preserve the existing V01 total busser formula,
  ...
  // V13.8.17I payout rule: employee payout is Total Before Meal minus Meal.
...
// V13.8.17I Calculate V01 + fresh page fix.

// V13.8.17I: Step-7 no longer erases Bartender Step-6 server totals.

// V13.8.17I Employee Clear All fix.

// V13.8.17I Daily Report tab + signature XLS.

// V13.8.17I dedicated Hourly Adjustment sub-app.

// V13.8.17I fresh page generated from current index.

// V13.8.17I Edit finalized Hourly report from Daily Report.

// V13.8.17I Daily Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.8.17I staff Remember Me with Firebase local/session persistence.

// V13.8.17I Main App button removed from Hourly workspace.

// V13.8.17I Daily Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.8.17I Remember Me for dedicated Hourly login.

// V13.8.17I Daily Report server signature + SMS.

// V13.8.17I Employee phone directory for Daily Report SMS.

// V13.8.17I recovered employee phone directory + reliable SMS composer.

// V13.8.17I Add/Edit employee + phone directory.

// V13.8.17I Tip Calculation batch workspace.

// V13.8.17I login role selector responsive UI fix.

// V13.8.17I Delete Team.

// V13.8.17I Delete individual Tip Calculation team member.

// V13.8.17I Cloud-backed Tip Calculation drafts.

// V13.8.17I live bar calculation after partial Grand Total save.

// V13.8.17I Team BAR Center with AM / 2-4 / PM automation.

// V13.8.17I show password checkboxes.

// V13.8.17I reliable team-card and BAR server input interactions.

// V13.8.17I separate Team Board and employee editor views.

// V13.8.17I persist BAR state to hourlyV1Batches cloud document.

// V13.8.17I secure Clear All, Owner Undo and permanent deletion.

// V13.8.17I BAR source-of-truth + payout report + signed PDF/SMS.

// V13.8.17I: no negative BAR fees; PM checkbox can be manually unchecked.

// V13.8.17I: exact-recipient SMS, employee historical reports, finalized V1 edit-in-place.

// V13.8.17I Check Tip soft delete + Owner Undo / Permanent Delete.

// V13.8.17I employee soft-delete ownership uses Firebase UID.

// V13.8.17I finalized edit hydration, autosave, quick Team Board/BAR navigation.

// V13.8.17I: direct final editing and two-way BAR/server sync.

// V13.8.17I larger UI, complete signed PDF/SMS, Daily Report Grand Total.

// V13.8.17I Grand Total = Total Before Meal + Cash Tip.

// V13.8.17I larger Daily Report; frozen Date + Employee columns.

// V13.8.17I simple Daily Report list, detail modal, Busser AM/PM split.

// V13.8.17I Daily Report stays in Tip Calculation; employee detail is a true modal; history retained.

// V13.8.17I Daily Report always visible in Tip Calculation.

// V13.8.17I restores full management tabs when logging in through Hourly V01.

// V13.8.17I professional non-overlapping PDF employee report layout.

// V13.8.17I removes Hourly V01 login and renames Hourly V1 to Tip Calculation.

// V13.8.17I clean role login buttons and simplified staff dashboard.

// V13.8.17I responsive all-device layout; owner credential UI does not expose plaintext Firebase passwords.

// V13.8.17I cashier role/UI removed.

// V13.8.17I stock-style Analytics chart page.

// V13.8.17I password-protected per-person delete + finalized report restore.

// V13.8.17I Future UI styling / mobile readability.
