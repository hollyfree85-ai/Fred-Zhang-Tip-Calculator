...
// V13.8.2 — reusable Show Password checkbox for all password/PIN inputs.
...
// V13.8.2 reliable team-card click handling (desktop/tablet/mobile).
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.8.2 hard guard: visible Step-6 result stays authoritative.
...
// V13.8.2 Calculate V01 + fresh page fix.

// V13.8.2: Step-7 no longer erases Bartender Step-6 server totals.

// V13.8.2 Employee Clear All fix.

// V13.8.2 Small Report tab + signature XLS.

// V13.8.2 dedicated Hourly Adjustment sub-app.

// V13.8.2 fresh page generated from current index.

// V13.8.2 Edit finalized Hourly report from Small Report.

// V13.8.2 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.8.2 staff Remember Me with Firebase local/session persistence.

// V13.8.2 Main App button removed from Hourly workspace.

// V13.8.2 Small Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.8.2 Remember Me for dedicated Hourly login.

// V13.8.2 Small Report server signature + SMS.

// V13.8.2 Employee phone directory for Small Report SMS.

// V13.8.2 recovered employee phone directory + reliable SMS composer.

// V13.8.2 Add/Edit employee + phone directory.

// V13.8.2 Hourly Adjustment V1 batch workspace.

// V13.8.2 login role selector responsive UI fix.

// V13.8.2 Delete Team.

// V13.8.2 Delete individual Hourly V1 team member.

// V13.8.2 Cloud-backed Hourly V1 drafts.

// V13.8.2 live bar calculation after partial Grand Total save.

// V13.8.2 Team BAR Center with AM / 2-4 / PM automation.

// V13.8.2 show password checkboxes.

// V13.8.2 reliable team-card and BAR server input interactions.

// V13.8.2 separate Team Board and employee editor views.

// V13.8.2 persist BAR state to hourlyV1Batches cloud document.

// V13.8.2 secure Clear All, Owner Undo and permanent deletion.

// V13.8.2 Small Report remains inside Hourly V1 workspace.
