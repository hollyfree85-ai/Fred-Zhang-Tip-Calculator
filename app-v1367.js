...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.6.7 hard guard: visible Step-6 result stays authoritative.
...
// V13.6.7 Calculate V01 + fresh page fix.

// V13.6.7: Step-7 no longer erases Bartender Step-6 server totals.

// V13.6.7 Employee Clear All fix.

// V13.6.7 Small Report tab + signature XLS.

// V13.6.7 dedicated Hourly Adjustment sub-app.

// V13.6.7 fresh page generated from current index.

// V13.6.7 Edit finalized Hourly report from Small Report.

// V13.6.7 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.6.7 staff Remember Me with Firebase local/session persistence.

// V13.6.7 Main App button removed from Hourly workspace.

// V13.6.7 Small Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.6.7 Remember Me for dedicated Hourly login.

// V13.6.7 Small Report server signature + SMS.

// V13.6.7 Employee phone directory for Small Report SMS.

// V13.6.7 recovered employee phone directory + reliable SMS composer.
