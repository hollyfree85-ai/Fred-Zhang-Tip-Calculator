...
const CACHE="fz-tip-v1341";
const CORE=["./","./index.html","./app-v1341.js?v=1341?v=1338?v=1337","./simple-ui-v1341.js?v=1341?v=1338?v=1337","./firebase-config.js","./push-config.js","./hourly-logic.js","./manifest.webmanifest", "./money-ready-chime.wav"];
