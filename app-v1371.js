...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.7.1 hard guard: visible Step-6 result stays authoritative.
...
// V13.7.1 Calculate V01 + fresh page fix.

// V13.7.1: Step-7 no longer erases Bartender Step-6 server totals.

// V13.7.1 Employee Clear All fix.

// V13.7.1 Small Report tab + signature XLS.

// V13.7.1 dedicated Hourly Adjustment sub-app.

// V13.7.1 fresh page generated from current index.

// V13.7.1 Edit finalized Hourly report from Small Report.

// V13.7.1 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.7.1 staff Remember Me with Firebase local/session persistence.

// V13.7.1 Main App button removed from Hourly workspace.

// V13.7.1 Small Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.7.1 Remember Me for dedicated Hourly login.

// V13.7.1 Small Report server signature + SMS.

// V13.7.1 Employee phone directory for Small Report SMS.

// V13.7.1 recovered employee phone directory + reliable SMS composer.

// V13.7.1 Add/Edit employee + phone directory.

// V13.7.1 Hourly Adjustment V1 batch workspace.

// V13.7.1 login role selector responsive UI fix.
