...
window.employeeDeleteTipCheckDate=async function(encodedDate){
  ...
  try{
    ...
    alert(`Delete failed: ${e.code||e.message}\n\nIf this says permission-denied, publish the V13.8.15 Firestore rules.`);
  }
};
...
// V13.8.15 finalized edit hydration, autosave, quick Team Board/BAR navigation.

// V13.8.15: direct final editing and two-way BAR/server sync.

// V13.8.15 larger UI, complete signed PDF/SMS, Small Report Grand Total.
