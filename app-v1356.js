...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.5.6 hard guard: visible Step-6 result stays authoritative.
...
// V13.5.6 Calculate V01 + fresh page fix.

// V13.5.6: Step-7 no longer erases Bartender Step-6 server totals.

// V13.5.6 Employee Clear All fix.

// V13.5.6 Small Report tab + signature XLS.
