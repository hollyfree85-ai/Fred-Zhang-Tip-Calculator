...
const CACHE="fz-tip-v13825p2";
const CORE=["./", "./index.html", "./fresh-v13825.html", "./app-v13825p2.js?v=138252", "./hourly-logic-v13825.js?v=13825", "./host-cashier-tip-v13825.js?v=13825", "./simple-ui-v13824p1.js?v=138241a", "./board-hotfix-v13825.js?v=13825", "./firebase-config.js", "./push-config.js", "./manifest.webmanifest", "./money-ready-chime.wav", "./icon-192.png", "./caishen-intro.png"];
...
self.addEventListener("activate",event=>{
  event.waitUntil(
    caches.keys()
      .then(keys=>Promise.all(keys.filter(k=>k.startsWith("fz-tip-")&&k!==CACHE).map(k=>caches.delete(k))))
