...
function clearSharedDeviceLoginFields(){
  try{
    ...
    if($("hourlyUsername")) $("hourlyUsername").value="";
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.6.3 hard guard: visible Step-6 result stays authoritative.
...
// V13.6.3 Calculate V01 + fresh page fix.

// V13.6.3: Step-7 no longer erases Bartender Step-6 server totals.

// V13.6.3 Employee Clear All fix.

// V13.6.3 Small Report tab + signature XLS.

// V13.6.3 dedicated Hourly Adjustment sub-app.

// V13.6.3 fresh page generated from current index.

// V13.6.3 Edit finalized Hourly report from Small Report.

// V13.6.3 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.6.3 staff Remember Me with Firebase local/session persistence.

// V13.6.3 Main App button removed from Hourly workspace.

// V13.6.3 Small Report delete row/delete all/PDF.
