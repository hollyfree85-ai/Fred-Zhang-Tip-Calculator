...
window.renderSmallReport=function(){
  ...
  if(!rows.length){
    body.innerHTML='<tr><td colspan="16" style="padding:24px;text-align:center">No finalized Hourly Adjustment reports for this filter.</td></tr>';
    return;
  }
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.5.7 hard guard: visible Step-6 result stays authoritative.
...
// V13.5.7 Calculate V01 + fresh page fix.

// V13.5.7: Step-7 no longer erases Bartender Step-6 server totals.

// V13.5.7 Employee Clear All fix.

// V13.5.7 Small Report tab + signature XLS.

// V13.5.7 dedicated Hourly Adjustment sub-app.
