...
// V13.7.9 — reusable Show Password checkbox for all password/PIN inputs.
...
// V13.7.9 reliable team-card click handling (desktop/tablet/mobile).
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.7.9 hard guard: visible Step-6 result stays authoritative.
...
// V13.7.9 Calculate V01 + fresh page fix.

// V13.7.9: Step-7 no longer erases Bartender Step-6 server totals.

// V13.7.9 Employee Clear All fix.

// V13.7.9 Small Report tab + signature XLS.

// V13.7.9 dedicated Hourly Adjustment sub-app.

// V13.7.9 fresh page generated from current index.

// V13.7.9 Edit finalized Hourly report from Small Report.

// V13.7.9 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.7.9 staff Remember Me with Firebase local/session persistence.

// V13.7.9 Main App button removed from Hourly workspace.

// V13.7.9 Small Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.7.9 Remember Me for dedicated Hourly login.

// V13.7.9 Small Report server signature + SMS.

// V13.7.9 Employee phone directory for Small Report SMS.

// V13.7.9 recovered employee phone directory + reliable SMS composer.

// V13.7.9 Add/Edit employee + phone directory.

// V13.7.9 Hourly Adjustment V1 batch workspace.

// V13.7.9 login role selector responsive UI fix.

// V13.7.9 Delete Team.

// V13.7.9 Delete individual Hourly V1 team member.

// V13.7.9 Cloud-backed Hourly V1 drafts.

// V13.7.9 live bar calculation after partial Grand Total save.

// V13.7.9 Team BAR Center with AM / 2-4 / PM automation.

// V13.7.9 show password checkboxes.

// V13.7.9 reliable team-card and BAR server input interactions.

// V13.7.9 separate Team Board and employee editor views.
