...
window.calculateHourlyV01=function(){
  ...
  // Normalize Pay Card Tip Fee naming from the original V01 engine.
  lastHourlyResult.cardFee=Number(lastHourlyResult.payCardTipFee ?? lastHourlyResult.cardFee ?? 0);
  lastHourlyResult.payCardTipFee=Number(lastHourlyResult.payCardTipFee ?? lastHourlyResult.cardFee ?? 0);
  ...
  $("hrCardFee").textContent=m(r.payCardTipFee ?? r.cardFee ?? 0);
