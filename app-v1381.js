...
// V13.8.1 — reusable Show Password checkbox for all password/PIN inputs.
...
// V13.8.1 reliable team-card click handling (desktop/tablet/mobile).
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.8.1 hard guard: visible Step-6 result stays authoritative.
...
// V13.8.1 Calculate V01 + fresh page fix.

// V13.8.1: Step-7 no longer erases Bartender Step-6 server totals.

// V13.8.1 Employee Clear All fix.

// V13.8.1 Small Report tab + signature XLS.

// V13.8.1 dedicated Hourly Adjustment sub-app.

// V13.8.1 fresh page generated from current index.

// V13.8.1 Edit finalized Hourly report from Small Report.

// V13.8.1 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.8.1 staff Remember Me with Firebase local/session persistence.

// V13.8.1 Main App button removed from Hourly workspace.

// V13.8.1 Small Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.8.1 Remember Me for dedicated Hourly login.

// V13.8.1 Small Report server signature + SMS.

// V13.8.1 Employee phone directory for Small Report SMS.

// V13.8.1 recovered employee phone directory + reliable SMS composer.

// V13.8.1 Add/Edit employee + phone directory.

// V13.8.1 Hourly Adjustment V1 batch workspace.

// V13.8.1 login role selector responsive UI fix.

// V13.8.1 Delete Team.

// V13.8.1 Delete individual Hourly V1 team member.

// V13.8.1 Cloud-backed Hourly V1 drafts.

// V13.8.1 live bar calculation after partial Grand Total save.

// V13.8.1 Team BAR Center with AM / 2-4 / PM automation.

// V13.8.1 show password checkboxes.

// V13.8.1 reliable team-card and BAR server input interactions.

// V13.8.1 separate Team Board and employee editor views.

// V13.8.1 persist BAR state to hourlyV1Batches cloud document.

// V13.8.1 secure Clear All, Owner Undo and permanent deletion.
