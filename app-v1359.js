...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.5.9 hard guard: visible Step-6 result stays authoritative.
...
// V13.5.9 Calculate V01 + fresh page fix.

// V13.5.9: Step-7 no longer erases Bartender Step-6 server totals.

// V13.5.9 Employee Clear All fix.

// V13.5.9 Small Report tab + signature XLS.

// V13.5.9 dedicated Hourly Adjustment sub-app.

// V13.5.9 fresh page generated from current index.

// V13.5.9 Edit finalized Hourly report from Small Report.
