...
// V13.8.17J — reusable Show Password checkbox for all password/PIN inputs.
...
// V13.8.17J reliable team-card click handling (desktop/tablet/mobile).
...
window.openHourlyWorkspacePanel=function(name){
  // V13.8.17JA: Hourly V01 is no longer an isolated sub-app.
...
function listenEmployeeHistoricalReports(){
  ...
  unsubs.push(onSnapshot(qh,snap=>{
    ...
    const host=$("employeeHistoricalReports");
    if(host){
      host.innerHTML=`<div class="notice danger"><b>Could not load My Tip Reports.</b><br>${esc(e.code||e.message||"Firestore permission error")}<br><span class="small">Publish the V13.8.17J hourlyReports employee-read rule.</span></div>`;
    }
  }));
}
...
async function loadDeletedItems(){
  ...
  try{
    ...
    if(currentProfile?.role==="owner"&&$("deletedItemsList")){
      $("deletedItemsList").innerHTML=`<div class="notice danger">Deleted / Undo could not load: ${esc(e.code||e.message)}. Publish the V13.8.17J Firestore rules.</div>`;
    }
  }
}
...
window.employeeDeleteTipCheckDate=async function(encodedDate){
  ...
  try{
    ...
    alert(`Delete failed: ${e.code||e.message}\n\nIf this says permission-denied, publish the V13.8.17J Firestore rules.`);
  }
};
...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.8.17J hard guard: visible Step-6 result stays authoritative.
  ...
  // V13.8.17J Busser split. Preserve the existing V01 total busser formula,
  ...
  // V13.8.17J payout rule: employee payout is Total Before Meal minus Meal.
...
// V13.8.17J Calculate V01 + fresh page fix.

// V13.8.17J: Step-7 no longer erases Bartender Step-6 server totals.

// V13.8.17J Employee Clear All fix.

// V13.8.17J Daily Report tab + signature XLS.

// V13.8.17J dedicated Hourly Adjustment sub-app.

// V13.8.17J fresh page generated from current index.

// V13.8.17J Edit finalized Hourly report from Daily Report.

// V13.8.17J Daily Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.8.17J staff Remember Me with Firebase local/session persistence.

// V13.8.17J Main App button removed from Hourly workspace.

// V13.8.17J Daily Report delete row/delete all/PDF.

setTimeout(loadHourlyRememberPreference,0);

// V13.8.17J Remember Me for dedicated Hourly login.

// V13.8.17J Daily Report server signature + SMS.

// V13.8.17J Employee phone directory for Daily Report SMS.

// V13.8.17J recovered employee phone directory + reliable SMS composer.

// V13.8.17J Add/Edit employee + phone directory.

// V13.8.17J Tip Calculation batch workspace.

// V13.8.17J login role selector responsive UI fix.

// V13.8.17J Delete Team.

// V13.8.17J Delete individual Tip Calculation team member.

// V13.8.17J Cloud-backed Tip Calculation drafts.

// V13.8.17J live bar calculation after partial Grand Total save.

// V13.8.17J Team BAR Center with AM / 2-4 / PM automation.

// V13.8.17J show password checkboxes.

// V13.8.17J reliable team-card and BAR server input interactions.

// V13.8.17J separate Team Board and employee editor views.

// V13.8.17J persist BAR state to hourlyV1Batches cloud document.

// V13.8.17J secure Clear All, Owner Undo and permanent deletion.

// V13.8.17J BAR source-of-truth + payout report + signed PDF/SMS.

// V13.8.17J: no negative BAR fees; PM checkbox can be manually unchecked.

// V13.8.17J: exact-recipient SMS, employee historical reports, finalized V1 edit-in-place.

// V13.8.17J Check Tip soft delete + Owner Undo / Permanent Delete.

// V13.8.17J employee soft-delete ownership uses Firebase UID.

// V13.8.17J finalized edit hydration, autosave, quick Team Board/BAR navigation.

// V13.8.17J: direct final editing and two-way BAR/server sync.

// V13.8.17J larger UI, complete signed PDF/SMS, Daily Report Grand Total.

// V13.8.17J Grand Total = Total Before Meal + Cash Tip.

// V13.8.17J larger Daily Report; frozen Date + Employee columns.

// V13.8.17J simple Daily Report list, detail modal, Busser AM/PM split.

// V13.8.17J Daily Report stays in Tip Calculation; employee detail is a true modal; history retained.

// V13.8.17J Daily Report always visible in Tip Calculation.

// V13.8.17J restores full management tabs when logging in through Hourly V01.

// V13.8.17J professional non-overlapping PDF employee report layout.

// V13.8.17J removes Hourly V01 login and renames Hourly V1 to Tip Calculation.

// V13.8.17J clean role login buttons and simplified staff dashboard.

// V13.8.17J responsive all-device layout; owner credential UI does not expose plaintext Firebase passwords.

// V13.8.17J cashier role/UI removed.

// V13.8.17J stock-style Analytics chart page.

// V13.8.17J password-protected per-person delete + finalized report restore.

// V13.8.17J Future UI styling / mobile readability.

// V13.8.17J password-gated deletes + Owner Deleted/Undo recovery.
