...
window.calculateHourlyV01=function(){
  ...
  if(isBartenderNow && bartenderWizardSnapshot){
    ...
    // V13.6.1 hard guard: visible Step-6 result stays authoritative.
...
// V13.6.1 Calculate V01 + fresh page fix.

// V13.6.1: Step-7 no longer erases Bartender Step-6 server totals.

// V13.6.1 Employee Clear All fix.

// V13.6.1 Small Report tab + signature XLS.

// V13.6.1 dedicated Hourly Adjustment sub-app.

// V13.6.1 fresh page generated from current index.

// V13.6.1 Edit finalized Hourly report from Small Report.

// V13.6.1 Small Report + New Entry.

setTimeout(loadStaffRememberPreference,0);

// V13.6.1 staff Remember Me with Firebase local/session persistence.
